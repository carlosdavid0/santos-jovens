...
export const metadata: Metadata = {
  ...
  description: "Histórias e reflexões sobre São João Paulo II para a juventude.",
  openGraph: {
    title: "São João Paulo II",
    description: "Histórias e reflexões sobre São João Paulo II para a juventude.",
    images: [
      {
        url: "https://upload.wikimedia.org/wikipedia/commons/7/7f/Pope_John_Paul_II_%2818731175945%29.jpg",
      },
    ],
  },
};
