...
import type { SaintStoriesCarouselProps } from "@/components/saints/types";

export function SaintStoriesCarousel({
  stories,
  profileAlt,
}: SaintStoriesCarouselProps) {
            ...
            <>
              ...
              <div
                ...
                style={{
                  ...
                  transition: !isDragging ? "transform 220ms ease-out" : "none",
                }}
              >
